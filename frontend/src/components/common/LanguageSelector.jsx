...
const LanguageSelector = ({ 
  ...
  const { currentLanguage, changeLanguage, LANGUAGE_CODES } = useLanguage();
    ...
    <div className={`flex items-center space-x-2 ${className}`}>
      ...
      <div className="relative">
        ...
        <select
          ...
          className={`pl-8 pr-4 py-1.5 rounded border ${selectClasses} appearance-none focus:outline-none focus:ring-1 focus:ring-blue-500`}
