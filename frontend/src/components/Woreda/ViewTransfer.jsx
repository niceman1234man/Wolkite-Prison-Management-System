    ...
    <div className="max-w-5xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          ...
          <p>{inmateData.sentenceStart}</p>
        </div>
        <div>
          <h3 className="text-xl font-semibold">sentence End:</h3>
          <p>{inmateData.sentenceEnd}</p>
        </div>
        <div>
      ...
      <div className="mt-6">
        ...
        <button className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onClick={deleteTransfer}>Delete</button>
      </div>
    </div>
  );
};
