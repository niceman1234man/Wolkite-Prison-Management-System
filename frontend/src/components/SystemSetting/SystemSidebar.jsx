      ...
      >
        ...
        <nav className="mt-4 space-y-1 px-2">
          ...
          >
            ...
            {!isCollapsed && <span className="ml-3">System Settings</span>}
          </NavLink>

          <NavLink
            to="/system-dashboard/database"
            className={({ isActive }) =>
              `flex items-center p-2 rounded-lg hover:bg-teal-600 transition-colors ${
                isActive ? "bg-teal-600" : ""
              } ${isCollapsed ? "justify-center" : "justify-start"}`
          ...
          >
            ...
            {!isCollapsed && <span className="ml-3">Database</span>}
          </NavLink>
