...
function ForgotPassword() {
  ...
  const onSubmitHandler = async (e) => {
    ...
    setLoading(true);
    try {
      console.log('Sending password reset request to:', '/user/forget');
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <header className="bg-teal-600 text-white shadow-md">
        <div className="container mx-auto px-4 py-4">
          <h1 className="text-xl md:text-2xl font-bold">Wolkite Prison Management System</h1>
        </div>
      </header>
      ...
      <footer className="bg-gray-800 text-white py-4">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm">&copy; {new Date().getFullYear()} Wolkite Prison Management System. All rights reserved.</p>
        </div>
      </footer>
